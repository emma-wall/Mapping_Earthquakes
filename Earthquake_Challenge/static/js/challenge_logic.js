...
let tetconicPlates = new L.LayerGroup();
...
let overlays = {
  ...
  "Tetconic Plates": tetconicPlates,
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) { 
    L.geoJson(data,{
      color: "grey", 
      weight: 2
    // Add to the tetonicPlates variable
    }).addTo(tetconicPlates);
    // Add tetonic layer group to the map
    tetconicPlates.addTo(map)
  });
});